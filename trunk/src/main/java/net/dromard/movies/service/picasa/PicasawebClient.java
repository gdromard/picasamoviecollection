...
public class PicasawebClient {
	...
	/**
	 * Retrieves the albums for the currently logged-in user. This is equivalent to calling {@link #getAlbums(String)} with "default" as the username.
	 */
	...
	/**
	 * Retrieves the tags for the given user. These are tags aggregated across the entire account.
	 */
	...
	/**
	 * Retrieves the tags for the given taggable entry. This is valid on user, album, and photo entries only.
	 */
	...
	/**
	 * Album-specific insert method to insert into the gallery of the current user, this bypasses the need to have a top-level entry object for parent.
	 */
	...
	/**
	 * Insert an entry into another entry. Because our entries are a hierarchy, this lets you insert a photo into an album even if you only have the album entry and not the album feed, making it quicker to traverse the hierarchy.
	 */
	...
	/**
	 * Helper function to allow retrieval of a feed by string url, which will create the URL object for you. Most of the Link objects have a string href which must be converted into a URL by hand, this does the conversion.
	 */
